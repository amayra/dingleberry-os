...
# GDB command: target remote localhost:1235
qemu-system-riscv64 -M virt -m 256M -kernel bin/fw_jump.elf -device loader,file=kernel/kernel.bin,addr=0x80200000 -nographic -serial stdio -monitor tcp::1234,server,nowait -gdb tcp::1235
